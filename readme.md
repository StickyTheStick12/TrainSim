...
### 1. [Introduction - Project Structure](#introduction---project-structure)
   ...
   - [Script Subdirectory](#script-subdirectory)
   - [JSONs Subdirectory](#jsons-subdirectory)

### 2. [Installation and Execution Guidelines](#installation-and-execution-guidelines)
   - [Quick Assistance](#quick-assistance)
   - [Dependencies Installation](#dependencies-installation)
   - [Makefile Commands](#makefile-commands)
   - [Halt the Program](#halt-the-program)

### 3. [Architecture Picture](#architecture-picture)
   - [High-Level Architecture](#high-level-architecture)

### 4. [HMI Description](#hmi-description)
   - [GUI Application](#gui-application)
   - [Web Application](#web-application)

### 5. [Back-end (SCADA-like) Server and PLCs Description](#back-end-scada-like-server-and-plcs-description)
...
### 6. [Communication Protocols (Operator-HMI-SCADA-PLCs)](#communication-protocols-operator-hmi-scada-plcs)
...
### 7. [Description of Normal Operation](#description-of-normal-operation)
   ...
   - [Continuous Operation (Quick Overview)](#continuous-operation-quick-overview)
      ...
      - [Updates to Departure Time and Switch Acquisition](#updates-to-departure-time-and-switch-acquisition)
      - [Sensor Communications](#sensor-communications)
      - [Updating Times from Trafikverket](#updating-times-from-trafikverket)

### 8. [Description of the Attack Scenario and Steps to Reproduce the Attack](#description-of-the-attack-scenario-and-steps-to-reproduce-the-attack)
   - [Attack Scenario Assumptions](#attack-scenario-assumptions)
   - [Attack Execution](#attack-execution)
      - [Positioning as a Proxy](#positioning-as-a-proxy)
      - [TCP Socket Establishment](#tcp-socket-establishment)
      - [Diffie-Hellman Key Exchange](#diffie-hellman-key-exchange)
      - [Modbus Communication](#modbus-communication)
   - [Response to SCADA Server](#response-to-scada-server)
      - [Sender's Response](#senders-response)
      - [Receiver's Response](#receivers-response)

### 9. [Key Rotation and Secure Communication](#key-rotation-and-secure-communication)
   - [Key Rotation for Authentication](#key-rotation-for-authentication)
      - [Soft Key Rotation](#soft-key-rotation)
      - [More Complex Key Rotation with Diffie-Hellman Group 14](#more-complex-key-rotation-with-diffie-hellman-group-14)
